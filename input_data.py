...
class AudioProcessor(object):
  ...
  # def get_features_for_stream(self, stream, model_settings, sess):
  # """Applies the feature transformation process to an audio stream.

  # Runs the feature generation process (generally producing a spectrogram from
  # the input samples) on a stream of audio data.

  # Returns:
  #   Numpy data array containing generated features. (Spectrograms.)
  # """
